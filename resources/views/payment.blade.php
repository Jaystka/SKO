        ...
        <div class="md:flex md:space-x-8">
                ...
                <div>
                    ...
                    <form class="space-y-4">
                        <div>
                            ...
                            <input type="text" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm" required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <textarea class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm" rows="6" required></textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Additional Information</label>
                            <textarea class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm" rows="2"></textarea>
                        </div>
                    </form>
                </div>
            </div>
            <div class="md:w-2/3 space-y-4 mt-8 md:mt-0">
                <div class="bg-[#F4F2E8] border-[#979797] border-2 p-8 h-full">
                    ...
                    <button class="w-full bg-[#FFF3B2] text-gray-800 hover:bg-black hover:text-white font-bold py-3 rounded-md mt-16">Place Order</button>
                </div>
        </div>
        </div>
    </main>
