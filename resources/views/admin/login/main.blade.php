...
<div class="flex items-center justify-center min-h-screen">
    <div class="bg-transparent rounded-lg p-8 w-full max-w-sm">
        ...
        <form action="#">
            ...
            <div class="text-center block max-w-xs mx-auto mb-4">
                <a href="#" class="text-sm font-extrabold text-black hover:text-yellow-400 hover:font-extrabold">Forgot password?</a>
            </div>
            <button type="submit"
